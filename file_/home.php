<?php include './_parsials/_template/header.php';?>
  <div class="container mt-4">
    <div class="p-5 text-dark  d-flex align-items-center position-relative" style="border-top: 4px solid brown; 
      ...
      <!-- Text Content -->
      <div class="" >
        <h1 style="font-size:60px;"><b>NeuraBot AI Engine v.3 </b></h1>
...
<div class="container mt-5">
  <h2 class="mb-3 fw-bolder">NeuraBot High Capabilites</h2>
  ...
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
    ...
    <div class="col">
      <div class="card p-3  bg-light" 
           style="border-top: 4px solid pink; border-right: 4px solid pink; 
                  border-radius: 0 0 50px 10px;">
